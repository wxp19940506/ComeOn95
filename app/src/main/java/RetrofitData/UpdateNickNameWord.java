...
public class UpdateNickNameWord {
    public Observable<SignStatue> updateNickName(String url, final int id, final String word){
        ...
        return Observable.create(new Observable.OnSubscribe<SignStatue>() {
            ...
            public void call(final Subscriber<? super SignStatue> subscriber) {
                if (!subscriber.isUnsubscribed()){
                    ...
                    Call<SignStatue> model = post.updatename(id,word);
